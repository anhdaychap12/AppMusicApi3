...
public class SongDTO{
    ...
    public SongDTO(Integer id, String title, Date releaseDate, Time duration, String avatar, String genre, String nameArtist, List<Integer> listPlaylist, List<String> listAlbum) {
        this.id = id;
        this.title = title;
